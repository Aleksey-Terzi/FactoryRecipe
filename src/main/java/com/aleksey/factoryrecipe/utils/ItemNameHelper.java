...
public class ItemNameHelper {
    ...
    public static String lookup(Material mat) {
        String key = Integer.toString(mat.getId());
        return map.containsKey(key) ? map.get(key) : mat.name();
    }
